...
class RecordsPresenter constructor(private val recordCategory: RecordCategory, private val recordsRepository: RecordsRepository) : LRPresenter<List<Record>, RecordsModel, RecordsView>() {


    override fun initialModelSingle(): Single<List<Record>> = Single.fromObservable(recordsRepository.getRecords(recordCategory))
