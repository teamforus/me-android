...
class ProductReservationPresenter(
    ...
    override fun initialModelSingle(): Single<List<Voucher>> = Single.fromObservable(
    ...
    override fun stateReducer(
        vs: LRViewState<ProductReservationModel>, change: PartialChange
    ): LRViewState<ProductReservationModel> {
