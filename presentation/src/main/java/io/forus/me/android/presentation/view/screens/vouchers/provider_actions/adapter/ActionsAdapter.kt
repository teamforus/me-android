package io.forus.me.android.presentation.view.screens.vouchers.provider_actions.adapter
...
class ActionsAdapter(var items: ArrayList<Foo>, val callback: Callback) : RecyclerView.Adapter<ActionsAdapter.MainHolder>() {
