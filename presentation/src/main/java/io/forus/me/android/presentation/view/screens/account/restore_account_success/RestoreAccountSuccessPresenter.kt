 ...
 */
class RestoreAccountSuccessPresenter constructor(
    private val token: String,
    private val accountRepository: AccountRepository,
    private val isExchangeToken: Boolean
) :
    ...
    override fun stateReducer(
        vs: LRViewState<RestoreAccountSuccessModel>,
        change: PartialChange
    ): LRViewState<RestoreAccountSuccessModel> {

        if (change !is RestoreAccountSuccessPartialChanges) return super.stateReducer(vs, change)

        return when (change) {
            is RestoreAccountSuccessPartialChanges.RestoreByEmailRequestStart -> vs.copy(
                model = vs.model.copy(
            ...
            is RestoreAccountSuccessPartialChanges.RestoreByEmailRequestEnd -> vs.copy(
                model = vs.model.copy(
            ...
            is RestoreAccountSuccessPartialChanges.RestoreByEmailRequestError -> vs.copy(
                model = vs.model.copy(
                    sendingRestoreByEmail = false,
            ...
            is RestoreAccountSuccessPartialChanges.ExchangeTokenResult -> vs.copy(
                model = vs.model.copy(
            ...
            is RestoreAccountSuccessPartialChanges.ExchangeTokenError -> vs.copy(
                model = vs.model.copy(
