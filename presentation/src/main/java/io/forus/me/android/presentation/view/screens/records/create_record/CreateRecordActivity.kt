...
import io.forus.me.android.presentation.view.screens.records.create_record.create_record_fragment.CreateRecordFragment.Companion.RECORD_TYPE_KEY_EXTRA
...
import io.forus.me.android.presentation.view.screens.records.create_record.create_record_fragment.CreateRecordFragment.Companion.RECORD_TYPE_TYPE_EXTRA
        ...
        nextBt.setOnClickListener {
            if (step == 1) {
                ...
                if (recordType != null) {
                    ...
                    args.putString(RECORD_TYPE_TYPE_EXTRA, recordType!!.type)
        ...
        if (error is io.forus.me.android.data.exception.RetrofitException && error.kind == RetrofitException.Kind.NETWORK) {
            ...
            if (error is RetrofitException && error.kind == RetrofitException.Kind.HTTP) {
                ...
                try {
                    ...
                    Log.d("forus", "newRecordError ${detailsError.message}")
                    Log.d("forus", "newRecordError ${detailsError.errorsString}")
