...
class ButtonSettings : android.support.v7.widget.AppCompatButton {
    ...
    private fun initBackground(){
        setBackgroundResource(if (!reverse && active )  R.drawable.button_main_raund_reverse else R.drawable.button_main_raund_reverse)
