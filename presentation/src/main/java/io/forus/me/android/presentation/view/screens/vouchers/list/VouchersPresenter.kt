...
class VouchersPresenter(val vouchersRepository: VouchersRepository) :
    LRPresenter<List<Voucher>, VouchersModel, VouchersView>() {

    override fun initialModelSingle(): Single<List<Voucher>> =
    ...
    override fun stateReducer(
        vs: LRViewState<VouchersModel>, change: PartialChange
    ): LRViewState<VouchersModel> {
